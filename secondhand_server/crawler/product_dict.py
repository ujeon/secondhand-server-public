stroller_dictionary = {
    ...
    ('ELENIRE', '엘레니어', '앨레니어', '앨래니어', '엘래니어', 'ELENIER'): (
        ("SESTOLITE", "SESTOLIGHT", "SESTO라이트", "세스토LITE", "새스토LITE", "세스토LIGHT", "새스토LIGHT" "세스토라이트", "새스토라이트" "세스토라이트프리미엄", "새스토라이트프리미엄", "SESTOLITEPREMIUM", "SESTOLITEPRIMIUM", "SESTOLIGHTPREMIUM", "세스토LITEPREMIUM", "새스토LITEPREMIUM", "세스토LIGHTPREMIUM", "새스토LIGHTPREMIUM", "세스토라이트PREMIUM", "새스토라이트PREMIUM", "SESTO라이트프리미엄",
         "SESTOLITE프리미엄", "세스토라이트T", "세스토라이트티", "새스토라이트T", "새스토라이트티", "SESTOLITET", "SESTOLIGHTT", "SESTO라이트T", "세스토LITET", "새스토LITET", "세스토LIGHTT", "새스토LIGHTT", "뉴세스토라이트", "뉴새스토라이트", "NEW세스토라이트", "NEW새스토라이트", "NEWSESTO라이트", "NEW세스토LITE", "NEW새스토LITE", "NEW세스토LIGHT", "NEW새스토LIGHT", "NEWSESTOLITE", "NEWSESTOLIGHT"),
        ...
        ("CROWN", "CRAWN", "크라운", "크라운에스", "크라운플러스", "CROWNS",
         "CROWNPLUS", "CROWN에스", "CROWN플러스", "크라운S", "크라운PLUS",),
        ("TEEK", "TEEKDUO", "NEWTEEKDUO", "티크듀오", "뉴티크듀오", "틱듀오", "뉴틱듀오", "TEEK듀오",
         "뉴TEEK듀오", "티크DUO", "NEWTEEK듀오", "NEW티크듀오", "NEW티크DUO", "뉴티크DUO"),
        ("SESTOS", "세스토트윈", "세스토S"),
    ...
    ('MEE-GO', '미고', 'MIGO', 'MEEGO', 'MEGO'):
    (('ALLNEWMINI', "올뉴미니"), ("MINIPLUS4", "미니플러스4", "미니4", "MINI4", "미니PLUS4", "PLUS4"), ("MINICABI", "미니캐비", "캐비", "MINI캐비",  "CABI", "CAEBI", "CEBI", "미니CABI", "미니CAEBI", "미니CEBI", "MINICEBI",
                                                                                           "MINICAEBI"), ("MINIPLUS3", "미니플러스3", "미니3", "MINI3", "미니PLUS3", "PLUS3"), ("MINIPLUS2", "미니플러스2", "미니2", "MINI2", "미니PLUS2", "PLUS2"), ('SWING', '스윙', '스읭'), ('GLIDE', 'GLIDER', '글라이드', '글라이더')),
    ('AIRBOSS', '에어보스', "애어보스"):
